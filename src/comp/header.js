...
const Header = () => {
  return (
    <div>
      <header style={{backgroundColor: 'grey'}} className="hide-when-mobile">
      <h1> 
         <Link to="/">
          KhAled
          </Link>
      ...
      <ul className="flex">
        <li className="main-list">
          <NavLink className="main-link" to="/html"> HTML
           </NavLink>
          <ul className="sub-ul">
    ...
    <header style={{backgroundColor: 'grey'}} className="show-when-mobile">
      ...
      <div className="show-on-click">
        ...
        <div className="main-div">
          ...
          <ul className="sub-div">
            ...
            <li><a href>CSS Examples</a></li>
            <li>
              <label className="mini-projects" htmlFor="mini">mini projects <i className="fas fa-plus" />
              </label>
